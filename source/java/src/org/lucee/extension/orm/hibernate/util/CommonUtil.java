...
public class CommonUtil {
    ...
    public static Query createQuery(Collection.Key[] columns, String[] types, int rows, String name)
    ...
    public static Mapping createMapping(Config config, String virtual, String physical) {
        return creator().createMapping(config, virtual, physical, null, INSPECT_UNDEFINED, true, false, false, false,
                true, true, null, -1, -1);
    }
    ...
    public static Property[] getProperties(Component c, boolean onlyPeristent, boolean includeBaseProperties,
        ...
        return c.getProperties(onlyPeristent, includeBaseProperties, preferBaseProperties,
